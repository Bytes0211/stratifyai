...
"""
            ...
            elif user_input.lower() == "/mcp" or user_input.lower().startswith("/mcp "):
                ...
                if _mcp_sub == "" or _mcp_sub == "status":
                    ...
                    if not use_mcp or mcp_engine is None:
                        ...
                        if _target_id not in _known_ids:
                            ...
                            try:
                                ...
                                _needs_start = _cur_status.status != "connected"
                            except Exception:
                                _needs_start = True
                    ...
                    if not use_mcp or mcp_engine is None:
                        ...
                        if _mcp_arg:
                            ...
                            console.print(
                                "[dim]No MCP tools discovered yet. Start a server first.[/dim]"
                            )
                            console.print()
                            continue

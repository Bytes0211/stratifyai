...
Step-by-step instructions for publishing StratifyAI to PyPI.
...
# This creates:
# - dist/stratifyai-0.1.0.tar.gz (source distribution)
# - dist/stratifyai-0.1.0-py3-none-any.whl (wheel)
```
...
tar -tzf dist/stratifyai-0.1.0.tar.gz | head -20
unzip -l dist/stratifyai-0.1.0-py3-none-any.whl | head -20
...
```bash
# Check PyPI page
open https://pypi.org/project/stratifyai/

# Install from PyPI
pip install stratifyai
...
StratifyAI follows [Semantic Versioning](https://semver.org/):
...
- **Production**: https://pypi.org/project/stratifyai/
- **Test**: https://test.pypi.org/project/stratifyai/

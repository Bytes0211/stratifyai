...
Provide a detailed code review."""
    ...
    def review(
        ...
        try:
            ...
            return {"review": None, "error": str(e), "success": False}
    ...
    def display_comparison(self, results: list[dict[str, Any]]):
        ...
        for i, result in enumerate(results, 1):
            if result["success"]:
                ...
                console.print(Panel(Markdown(result["review"]), border_style="green"))


def main():
    """Main CLI entry point."""
    parser = argparse.ArgumentParser(description="Review code using AI models")
    parser.add_argument("file", type=Path, help="Code file to review")
    parser.add_argument(
        "--focus",
    ...
    parser.add_argument(
        "--model", "-m", help="Specific model to use (default: auto-route)"
    )
    parser.add_argument(
        "--compare",
        "-c",
    ...
    parser.add_argument(
        "--stream", "-s", action="store_true", help="Enable streaming output"
    )

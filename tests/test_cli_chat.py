        ...
        with patch(
            ...
            result = runner.invoke(
                ...
                [
                    ...
                    "gpt-4.1-mini",
                    "--temperature",
                    "0.7",  # Explicitly provide temperature
                    "--system",
...
class TestChatImplSingleTurn:
    ...
    @patch("cli.stratifyai_cli.Prompt.ask")
    @patch("cli.stratifyai_cli.LLMClient")
    def test_exit_without_save(self, mock_client_class, mock_prompt, mock_console):
...
class TestChatImplSave:
    ...
    def test_saves_conversation_on_save_and_exit(
        ...
        mock_console.print.assert_any_call(
            "[green]✓ Saved to test_conversation.md[/green]"
        )
    ...
    def test_saves_multi_turn_conversation_history(
        ...
        client_instance.chat_completion_sync.side_effect = [
            mock_response_1,
            mock_response_2,
            mock_response_3,
        ]

...
class TestJSONExtractor:
    ...
    def test_infer_nested_structure(self):
        ...
        data = {"user": {"name": "Alice", "contacts": ["email@test.com", "phone"]}}
        schema = infer_json_schema(data)
...
class TestLogExtractor:
    ...
    def test_extract_log_summary(self, tmp_path):
        ...
        log_file.write_text("ERROR: Failed to connect\nERROR: Timeout occurred\n")
...
class TestCodeExtractor:
    ...
    def test_async_function(self, tmp_path):
        ...
        py_file = tmp_path / "test.py"
        py_file.write_text("async def fetch_data():\n    pass\n")
